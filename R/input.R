...
init_input <- function() {
  ...
  input$symptoms$logit_p_cough_COPD_by_sex <- cbind(male=c(intercept=4.4006,
                                                           age=-0.0412,
                                                           smoking=0.6036,
                                                           packyears=0, fev1=-0.9564),
                                                    female=c(intercept=4.4006-0.9472,
                                                             age=-0.0412,
                                                             smoking=0.6036,
                                                             packyears=0, fev1=-0.9564))
  ...
  input$symptoms$logit_p_cough_nonCOPD_by_sex <- cbind(male=c(intercept=-5.2872,
                                                              age=0.03429,
                                                              smoking=0.3786, packyears=0),
                                                       female=c(intercept=-5.2872+0.2178,
                                                                age=0.03429,
                                                                smoking=0.3786, packyears=0))
  ...
  input$symptoms$logit_p_phlegm_COPD_by_sex <- cbind(male=c(intercept=3.5726,
                                                            age=-0.02422,
                                                            smoking=1.0754, packyears=0, fev1=-1.6443),
                                                     female=c(intercept=3.5726-2.089, age=-0.02422,
                                                              smoking=1.0754, packyears=0, fev1=-1.6443))
  ...
  input$symptoms$logit_p_phlegm_nonCOPD_by_sex <- cbind(male=c(intercept=-10.3164,
                                                               age=0.02771, smoking=0.5865, packyears=0),
                                                        female=c(intercept=-10.3164-0.3459,
                                                                 age=0.02771, smoking=0.5865, packyears=0))
  ...
  input$symptoms$logit_p_dyspnea_COPD_by_sex <-  cbind(male=c(intercept=4.8358,
                                                              age=-0.00891,
                                                              smoking=0.4177, packyears=0, fev1=-1.9942),
                                                       female=c(intercept=4.8358-0.6346, age=-0.00891,
                                                                smoking=0.4177, packyears=0, fev1=-1.9942))
  ...
  input$symptoms$logit_p_dyspnea_nonCOPD_by_sex <- cbind(male=c(intercept=-7.1802, age=0.07002, smoking=0.8388, packyears=0),
                                                         female=c(intercept=-7.1802+0.9343, age=0.07002,
                                                                  smoking=0.8388, packyears=0))
  ...
  input$symptoms$logit_p_wheeze_COPD_by_sex <- cbind(male=c(intercept=14.2686, age=-0.1408, smoking=0.1345, packyears=0, fev1=-2.3122),
                                                     female=c(intercept=14.2686-1.4995, age=-0.1408,
                                                              smoking=0.1345, packyears=0, fev1=-2.3122))
